...
export default function AboutPage() {
  return (
    <>
      ...
      <div className={`${styles.body} ${pageStyles.story}`}>
        ...
        <figure className={pageStyles.figure}>
          <a href={productBrain.src} target="_blank" rel="noopener noreferrer" aria-label="Open the Property Brain screenshot at full size">
            <Image src={productBrain} alt="Moche-AI Property Brain showing host-managed property knowledge organized by topic" sizes="(max-width: 820px) 100vw, 800px" className={pageStyles.image} />
          </a>
        ...
        <figure className={pageStyles.figure}>
          <a href={productPortal.src} target="_blank" rel="noopener noreferrer" aria-label="Open the guest portal screenshot at full size">
            <Image src={productPortal} alt="Moche-AI guest portal with property information and routes to ask questions or contact the host" sizes="(max-width: 820px) 100vw, 800px" className={pageStyles.image} />
          </a>
        ...
        <figure className={pageStyles.figure}>
          <a href={productUpdates.src} target="_blank" rel="noopener noreferrer" aria-label="Open the knowledge updates screenshot at full size">
            <Image src={productUpdates} alt="Moche-AI knowledge updates queue showing proposed changes awaiting host approval" sizes="(max-width: 820px) 100vw, 800px" className={pageStyles.image} />
          </a>
