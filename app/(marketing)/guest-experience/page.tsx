...
export default function GuestExperiencePage() {
  return (
    <>
      ...
      <PageHero
        src={productPortal}
        alt="The Moche-AI guest portal open in a phone browser, showing the chat interface and property details for an active stay"
        caption="The guest portal during an active stay. One link, no app, no account — just answers drawn from the host’s approved property details."
        priority
      />
