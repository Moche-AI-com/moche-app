...
FIELDS += [
    ...
    f("wifi_password", "Wi-Fi password", "connectivity", "secret",
      ...
      "Legacy credential field. Do not enter a password; use password location and connection instructions.",
      scrape_hint=None, vault=True, gap_weight=0.0, hard_block=False, applicability="has_wifi",
      requires_on_failure=True, on_failure_field="wifi_troubleshooting"),
    f("wifi_password_location", "Wi-Fi password location", "connectivity", "text",
      "public_guest", "guest_prearrival", ["pre-arrival", "check-in", "mid-stay"], 180,
      "brain_values", "value",
      "Where can guests find the Wi-Fi password? Give the exact location. Do not enter the password itself.",
      gap_weight=3.0, hard_block=True, applicability="has_wifi"),
    f("wifi_connection_instructions", "Wi-Fi connection instructions", "connectivity", "text",
      "public_guest", "guest_prearrival", ["pre-arrival", "check-in", "mid-stay"], 180,
      "brain_values", "value",
      "What steps should guests follow to connect to Wi-Fi? Refer to the password location; never include the password.",
      gap_weight=1.0, applicability="has_wifi"),
