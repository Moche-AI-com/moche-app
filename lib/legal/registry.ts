...
export const LEGAL_DOCS: LegalDocMeta[] = [
  {
    ...
    summary: 'The agreement governing host use of Moche.AI, including AI-output disclaimers and liability limits.',
  },
  {
    slug: 'privacy',
    ...
    version: 'v1.0.0',
    lastUpdated: '2026-07-22',
    summary: 'How we collect, use, and protect personal data under GDPR, UK GDPR, and CCPA/CPRA.',
  },
  {
    slug: 'refund',
